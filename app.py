...
#"https://i.pinimg.com/736x/1c/f7/3e/1cf73eab97b129aff30d3f2bc815abb3.jpg" covid pic
# Adding Background Image
# st.image("D:/bhavv - Copy/AICTE/all data/p3.jpg", use_column_width=True)  to load img but not as background
...
def set_background(image_path):
    base64_str = get_base64_encoded_image(image_path)
    background_css = f"""
    <style>
    ...
    /* Make text color light (white) for better visibility */
    [data-testid="stMarkdownContainer"], 
    .stTextInput label, .stSelectbox label, 
    .stNumberInput label, .stTextArea label, 
    .stButton>button, .stRadio label, .stTitle, .stHeader {{
...
# Provide your local image path
set_background("D:/bhavv - Copy/AICTE/all data/p3.jpg")

# Add the glassmorphic form container
